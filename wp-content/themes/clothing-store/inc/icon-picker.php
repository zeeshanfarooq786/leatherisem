...
class Clothing_Store_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'clothing-store' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $clothing_store_font_awesome_icon_array = clothing_store_font_awesome_icon_array();
                    foreach ($clothing_store_font_awesome_icon_array as $clothing_store_font_awesome_icon) {
                            $icon_class = $this->value() == $clothing_store_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($clothing_store_font_awesome_icon).'"></i>
                            <span class="clothing-store-social-class">'.esc_attr($clothing_store_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function clothing_store_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'clothing-store-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'clothing_store_customizer_script' );

if(!function_exists('clothing_store_font_awesome_icon_array')){
    function clothing_store_font_awesome_icon_array(){
