 ...
 * Control - Switch.
 *
 * @package Clothing Store Themes
 */

if( class_exists( 'WP_Customize_Control' ) ) {
	class Clothing_Store_Customizer_Customcontrol_Switch extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'clothing-store-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.js', array( 'jquery' ) );

			wp_enqueue_style( 'clothing-store-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.css', '', time() );
