...
function clothing_store_custom_styles($custom) {
	...
	wp_add_inline_style( 'clothing-store-style', $custom );

}

add_action( 'wp_enqueue_scripts', 'clothing_store_custom_styles' );

//Sanitizes Fonts
function clothing_store_sanitize_fonts( $input ) {
	$valid = array(
		'' => 'Select',
