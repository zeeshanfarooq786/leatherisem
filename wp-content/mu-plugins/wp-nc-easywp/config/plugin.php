...
return [
  ...
  */
  ...
  "ajax" => [
    "WPNCEasyWP\Providers\AutomaticUpdates\AutomaticUpdatesAjax",
    "WPNCEasyWP\Providers\HackGuardian\HackGuardianAjax"
  ],
  ...
  */
  ...
  "providers" => [
    "WPNCEasyWP\Providers\AutomaticUpdates\AutomaticUpdatesSyncCron",
    "WPNCEasyWP\Providers\AutomaticUpdates\AutomaticUpdatesServiceProvider",
    "WPNCEasyWP\Providers\Checker\CheckerServiceProvider",
    "WPNCEasyWP\Providers\HackGuardian\HackGuardianServiceProvider",
    "WPNCEasyWP\Providers\OpcodeCache\OpcodeCacheServiceProvider",
    "WPNCEasyWP\Providers\Redis\RedisServiceProvider",
    "WPNCEasyWP\Providers\Varnish\VarnishServiceProvider",
    "WPNCEasyWP\Providers\ClearByHttpRequestServiceProvider",
    "WPNCEasyWP\Providers\WordPressLoginServiceProvider",
    "WPNCEasyWP\Providers\WordPressVersionServiceProvider",
    "WPNCEasyWP\Providers\EasyWPServiceProvider",
    "WPNCEasyWP\Providers\HeartbeatServiceProvider",
    "WPNCEasyWP\Providers\AffiliateServiceProvider",
    "WPNCEasyWP\Providers\MonarxServiceProvider",
  ],
];
